...
__export(src_exports, {
  ReactParser: () => ReactParser_default,
  ReactRenderer: () => ReactRenderer_default,
  default: () => src_default
});
...
h_fn = function(el, children = null, props = {}) {
  ...
  __privateMethod(this, _ReactRenderer_instances, incrementElId_fn).call(this);
  return (0, import_react.createElement)(el, __spreadValues(__spreadValues({}, props), elProps), children);
};
...
var markedInstance = new import_marked.Marked();
var Markdown = (props) => {
  var _a, _b, _c;
