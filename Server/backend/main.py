    ...
    if not patient_data:
        ...
        try:
            ...
            if not isinstance(response, dict):
                raise ValueError("Response is not a dicxztionary.")
